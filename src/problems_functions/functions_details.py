...
def Get_Functions_details(F):
    switch = {
        ...
        'F5': (F5, -30, 30, 50, 0),
        'F6': (F6, -100, 100, 50, 0),
        'F7': (F7, -1.28, 1.28, 50, 0),
        'F8': (F8, -500, 500, 10, -418.98),
        'F9': (F9, -5.12, 5.12, 50, 0),
        'F10': (F10, -32, 32, 50, 0),
        'F11': (F11, -600, 600, 50, 0),
        'F12': (F12, -50, 50, 50, 0),
        'F13': (F13, -50, 50, 50, 0),
        'F14': (F14, -65, 65, 2, 1),
        'F15': (F15, -5, 5, 4, 0.00030),
        'F16': (F16, -5, 5, 2, 1.0316),
        'F17': (F17, -5, 15, 2, 0.398),
        'F18': (F18, -2, 2, 2, 3),
        'F19': (F19, 1, 3, 3, -3.32),
        'F20': (F20, 0, 1, 6, -3.32),
        'F21': (F21, 0, 10, 4, -10.1532),
        'F22': (F22, 0, 10, 4, -10.4028),
        'F23': (F23, 0, 10, 4, -10.5363)
    }
